<?php
   ...
   if($_GET["action"] === 'synchRMAuctionInvoice'){
      ...
      $item='Roses';
      $invoiceHeaderQuery="SELECT AuctionInvoiceHeaderId, AuctionId, ClientId, InvoiceDate, InvoiceNo, AuctionWeekNo, QBInvoiceNo FROM AuctionInvoiceHeader WHERE Finalized = Yes AND ExporterId = 24 AND InvoiceDate Between #1/1/2025# And #31/12/2026# ORDER BY AuctionInvoiceHeaderId DESC";
