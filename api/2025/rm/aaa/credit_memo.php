<?php
   ...
   if($_GET["action"] === 'syncRmCreditNotes'){
      ...
      $creditNoteQuery = "SELECT CreditNoteId, CreditNoteNo, CreditNoteDate, CreditNoteValue, ClientId, Notes FROM CreditNote WHERE ExporterId = 24 AND CreditNoteDate Between #9/4/2026# And #12/31/2026#  ORDER BY CreditNoteId";
   ...
   if($_GET["action"] === 'getRmAaaCreditNotesStats'){
      ...
      $unsynchedCountQuery = "SELECT COUNT(*) FROM CreditNote WHERE ExporterId = 24 AND QBTransferStatus IS NULL AND CreditNoteDate Between #9/4/2026# And #12/31/2026#";
