<?php
   ...
   if($_GET["action"] === 'getRmFgPayments'){
      ...
      $unsynchedCountQuery = "SELECT COUNT(*) FROM CustomerPayment WHERE ExporterId = 25 AND QBTransferStatus IS NULL AND PaymentDate Between #6/1/2025# AND #12/31/2026#";
