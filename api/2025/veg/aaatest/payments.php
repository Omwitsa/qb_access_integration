<?php
   ...
   if($_GET["action"] === 'getVegaaaPaymentsStats'){
      ...
      $unsynchedCountQuery = "SELECT COUNT(*) FROM CustomerPayment WHERE ExporterId = 1 AND QBTransferStatus IS NULL AND PaymentDate Between #5/19/2025# AND #12/31/2026#";
