<?php
   ...
   if($_GET["action"] === 'syncVegPayments'){
      $custPaymentQuery = "SELECT CustomerPaymentId, CustomerId, PaymentDate, ForeignAmountPaid, BankId, Description FROM CustomerPayment WHERE PaymentDate  Between #6/4/2025# And #12/31/2026# AND (QBTransferStatus <> 1 OR QBTransferStatus IS NULL)  ORDER BY CustomerPaymentId";
