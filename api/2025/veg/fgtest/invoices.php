<?php
   ...
   if($_GET["action"] === 'getVegFGInvoicesStats'){
      ...
      $unsynchedInvoiceCountQuery = "SELECT COUNT(*) FROM InvoiceHeader WHERE Finalized = Yes AND ExporterId = 2 AND  QBTransferStatus IS NULL AND InvoiceDate Between #1/1/2026# AND #31/12/2026#";
